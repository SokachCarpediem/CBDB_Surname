...
| `build_cbdb_surname_tables.ipynb` | Build the 《百家姓》 and non-《百家姓》 raw tables (simplified and traditional merging) |
...
| `bjx_raw.json` | 《百家姓》 504-rank table as `[surname, count, rank]` |
| `extra_raw.json` | Non-《百家姓》 surnames as `[surname, count]` |
